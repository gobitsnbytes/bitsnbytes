...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-[#120f0a] bg-white z-0 h-full w-full rounded-none border-4 shadow-[8px_8px_0px_0px_#120f0a]",
        className
      )}
    >
      <div className="border-[#120f0a] flex flex-row items-center gap-x-2 border-b-4 bg-[#fee9cf] p-4">
        <div className="flex flex-row gap-x-2">
          <div className="h-3.5 w-3.5 rounded-full border-2 border-[#120f0a] bg-red-500"></div>
          <div className="h-3.5 w-3.5 rounded-full border-2 border-[#120f0a] bg-yellow-500"></div>
          <div className="h-3.5 w-3.5 rounded-full border-2 border-[#120f0a] bg-green-500"></div>
        </div>
        <span className="font-mono text-xs font-black uppercase text-[#120f0a] ml-2 tracking-wide">
          shuttle-loader.sh
        </span>
      </div>
      <pre className="p-5 bg-white font-mono text-[#120f0a] text-left leading-relaxed">
