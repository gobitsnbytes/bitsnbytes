        ...
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6">
          ...
          >
            <div className="relative m-auto h-full w-full flex flex-col items-center justify-center">
              <div className="relative border-3 border-[#120f0a] bg-[#fee9cf] px-6 py-4 shadow-[4px_4px_0px_0px_#120f0a] transition-transform group-hover:scale-105 group-hover:-rotate-1">
                <span className="mx-auto block w-fit text-5xl md:text-6xl font-black text-[#120f0a] tracking-tighter font-mono">
                  1400+
                </span>
                <span className="absolute -top-3 -right-3 border-2 border-[#120f0a] bg-[#fc920d] px-2 py-0.5 text-[9px] font-mono font-bold uppercase tracking-wider shadow-[1.5px_1.5px_0px_0px_#120f0a] rounded-none">
                  LIVE
                </span>
              </div>
          ...
          >
            <div className="relative mx-auto flex aspect-square size-24 items-center justify-center border-3 border-[#120f0a] bg-[#fee9cf] shadow-[4px_4px_0px_0px_#120f0a] transition-transform group-hover:scale-105 group-hover:rotate-2">
              ...
              <span className="absolute -top-2.5 -right-2.5 border-2 border-[#120f0a] bg-[#97192c] text-white px-2 py-0.5 text-[8px] font-mono font-bold uppercase tracking-wider shadow-[1.5px_1.5px_0px_0px_#120f0a]">
                NEW
              </span>
            </div>
          ...
          >
            <div className="relative mx-auto flex aspect-square size-24 items-center justify-center border-3 border-[#120f0a] bg-[#fee9cf] shadow-[4px_4px_0px_0px_#120f0a] transition-transform group-hover:scale-105 group-hover:-rotate-2">
              <CodeXml className="h-10 w-10 text-[#97192c]" />
              <span className="absolute -top-2.5 -right-2.5 border-2 border-[#120f0a] bg-[#fc920d] text-[#120f0a] px-2 py-0.5 text-[8px] font-mono font-bold uppercase tracking-wider shadow-[1.5px_1.5px_0px_0px_#120f0a]">
                CITY
              </span>
            </div>
            <div className="relative z-10 mt-8 space-y-3 text-center">
          ...
          >
            <div className="grid sm:grid-cols-2 h-full gap-6">
              ...
              <div className="relative min-h-[160px] border-3 border-[#120f0a] bg-[#eae8e4] p-4 sm:ml-4 overflow-hidden shadow-[4px_4px_0px_0px_#120f0a] flex flex-col justify-between">
                <div className="absolute left-3 top-3 flex gap-1.5 z-20">
                  <span className="block size-2.5 rounded-full border-2 border-[#120f0a] bg-red-500"></span>
                  <span className="block size-2.5 rounded-full border-2 border-[#120f0a] bg-yellow-400"></span>
                  <span className="block size-2.5 rounded-full border-2 border-[#120f0a] bg-green-500"></span>
                </div>
                {/* Neobrutalist line chart mockup */}
                <div className="relative w-full h-[95px] mt-6 flex items-end">
                  <svg 
                  ...
                  >
                    {/* Gridlines */}
                    <line x1="0" y1="20" x2="200" y2="20" stroke="#120f0a" strokeWidth="1.5" strokeDasharray="3 3" opacity="0.15" />
                    <line x1="0" y1="50" x2="200" y2="50" stroke="#120f0a" strokeWidth="1.5" strokeDasharray="3 3" opacity="0.15" />
                    <line x1="0" y1="80" x2="200" y2="80" stroke="#120f0a" strokeWidth="1.5" strokeDasharray="3 3" opacity="0.15" />
                    ...
                    {/* Dot points */}
                    <circle cx="90" cy="40" r="4.5" fill="#fc920d" stroke="#120f0a" strokeWidth="2" />
                    <circle cx="150" cy="25" r="4.5" fill="#fc920d" stroke="#120f0a" strokeWidth="2" />
                    <circle cx="200" cy="10" r="4.5" fill="#fc920d" stroke="#120f0a" strokeWidth="2" />
                  </svg>
                </div>
              </div>
            </div>
          ...
          >
            <div className="grid sm:grid-cols-2 h-full gap-6">
              ...
              <div className="relative mt-6 sm:mt-0 before:absolute before:inset-y-0 before:left-1/2 before:w-[3px] before:bg-[#120f0a] hidden sm:block">
                <div className="relative flex h-full flex-col justify-center space-y-6">
                  <div className="relative flex w-[calc(50%+1.5rem)] items-center justify-end gap-3 transition-all hover:-translate-y-0.5 duration-150">
                    <span className="block h-fit border-2 border-[#120f0a] bg-[#fee9cf] px-3 py-1 text-xs font-mono font-black uppercase tracking-wider text-[#120f0a] shadow-[2px_2px_0px_0px_#120f0a] transition-transform hover:rotate-1">
                      Yash Singh
                    </span>
                    <div className="size-10 shrink-0 rounded-none overflow-hidden border-2 border-[#120f0a] shadow-[2px_2px_0px_0px_#120f0a] bg-white">
                      <Image
                  ...
                  <div className="relative ml-[calc(50%-1rem)] flex items-center gap-3 transition-all hover:-translate-y-0.5 duration-150">
                    <div className="size-12 shrink-0 rounded-none overflow-hidden border-2 border-[#120f0a] shadow-[2px_2px_0px_0px_#120f0a] bg-white">
                      <Image
                        className="size-full object-cover"
                        src="/team/akshat.jpg"
                        alt="Akshat"
                    ...
                    <span className="block h-fit border-2 border-[#120f0a] bg-[#fda83d] px-3 py-1 text-xs font-mono font-black uppercase tracking-wider text-[#120f0a] shadow-[2px_2px_0px_0px_#120f0a] transition-transform hover:-rotate-1">
                      Akshat Kushwaha
                    </span>
                  </div>
                  <div className="relative flex w-[calc(50%+1.5rem)] items-center justify-end gap-3 transition-all hover:-translate-y-0.5 duration-150">
