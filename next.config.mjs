    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://va.vercel-scripts.com https://tally.so https://hcaptcha.com https://*.hcaptcha.com https://static.cloudflareinsights.com https://embed.lu.ma https://*.lu.ma; style-src 'self' 'unsafe-inline' https://hcaptcha.com https://*.hcaptcha.com; img-src 'self' blob: data: https:; font-src 'self' data: https://r2cdn.perplexity.ai https://frontend-cdn.perplexity.ai https://*.perplexity.ai; connect-src 'self' https://vitals.vercel-insights.com https://hcaptcha.com https://*.hcaptcha.com https://*.supabase.co https://cloudflareinsights.com https://*.lu.ma; frame-src 'self' https://tally.so https://hcaptcha.com https://*.hcaptcha.com https://discord.com https://*.discord.com https://*.notion.site https://www.notion.so https://embed.lu.ma https://*.lu.ma;"
          }
        ]
      }
    ]
